...
const originalSetDescription =
  EmbedBuilder.prototype.setDescription;

const originalSetFooter =
  EmbedBuilder.prototype.setFooter;

const originalSetTimestamp =
  EmbedBuilder.prototype.setTimestamp;

EmbedBuilder.prototype.setDescription = function (
  description = ''
) {
  const descString =
    sanitizeEmbedText(
  ...
  this[
    EMBED_BASE_DESCRIPTION_SYMBOL
  ] = descString;

  return originalSetDescription.call(
    this,
    descString
  );
};

EmbedBuilder.prototype.setFooter = function (
  footer
) {
  const footerText =
    sanitizeEmbedText(
...
export function createEmbed({
  ...
  if (author) {
    try {
      ...
      // Ignore author formatting errors.
    }
  } else if (
  ...
  if (footer) {
    try {
      ...
      // Ignore footer formatting errors.
    }
  } else if (
